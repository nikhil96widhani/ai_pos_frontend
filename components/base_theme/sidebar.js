  ...
  return (
    <Box sx={{ display: 'flex', flexGrow: 1 }}>
      <AppBar position="fixed" open={open}>
          <PrimarySearchAppBar swipableDrawerToggle={props.swipableDrawerToggle} open={open} />
      </AppBar>
      {props.admin ? drawerAndMainContent() : props.main_content}
    </Box>
  );
}